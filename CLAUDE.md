...
- **Multiple Output Support**: Returns all images generated by a workflow with structured mapping
...
Client → Query Job Tool → Check Status/Get Result (same endpoint)
```
...
**For completed jobs:**
Returns metadata + structured outputs + all image resources:
```json
{
  "job_id": "...",
  "service": "text_to_image",
